...
function build_rules(wordList) {
    ...
    var rules = {
        ...
        alaAsPredicate: new Err(
            ...
            "<em>ala</em> as the main predicate is uncommon.\n\nTo negate a thing, <em>ala</em> is placed after, not before.",
            "possible-error",
            "https://github.com/kilipan/nasin-toki#negation"
        ),
        ...
        suspiciousVocativeO: new Err(
            ...
            '<em>toki o</em> by itself would mean something like "Hey speech!" as if the speech itself was addressed.\n\nDid you mean:\n<em>toki</em>',
            'possible-error',
        ...
        */
        ...
        sandboxWord: new Err(
            ...
            '<strong>Sandbox</strong> word. The sandbox is a collection of proposed words which are <strong>not actively in use</strong>.\n\n'
            + 'If you are a learner, <strong>please stick to the main dictionary</strong> - these words will not help you speak the language.',
            'uncommon',
